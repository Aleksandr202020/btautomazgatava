        ...
        {step === 8 && done ? (
          <div className="space-y-5 text-center">
            ...
            <div className="flex flex-col gap-2">
              <a className="inline-flex h-12 items-center justify-center rounded-md border border-border text-sm" href={googleCalUrl(done)} target="_blank" rel="noreferrer">
                {t("addCalendar")}
              </a>
